...
<div class="entity_wrapper">
    ...
    <div class="entity_meta"><a href="#" target="_self">BTU 2020</a>, by: <a href="{{ route('author') }}" target="_self">Lasha Sulukhia</a>
    </div>
    <!-- entity_meta -->
...
<div class="readers_comment">
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h2 class="media-heading"><a href="#">{{ $comm->name }}</a></h2>
...
<div class="widget">
    ...
    <div class="media">
        ...
        <div class="media-body">
            ...
            </h3> <span class="media-date">10Aug- 2015, by: <a href="#">Eric joan</a></span>
